...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1: Horse population for all provinces in Canada between 1948-1972", out.width= "100%"}
...
kable(max_horses,
      caption = "Table 1: Maximum and minimum number of hourses for each province between 1940-1972")
```

Below we zoom in and look at the province of `r params$province[1]`:
